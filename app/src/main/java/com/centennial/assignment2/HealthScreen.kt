...
fun HealthScreen(
    ...
    val backgroundBrush = Brush.verticalGradient(
        colors = listOf(Color(0xFFF696B7), Color(0xFFF44336))
    )
    ...
    Box(
        ...
        Column(
            ...
            Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
                ...
                Text("Student Name: Merlin George", fontSize = 16.sp)
                Text("Student ID: 301475560", fontSize = 16.sp)
            }
        }
    }
}
